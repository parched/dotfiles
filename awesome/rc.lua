...
-- beautiful.init("/home/james/.config/awesome/themes/parched/theme.lua")
...
-- tags = {
-- names = { "1:main", "2:www", "3:music", "4:urxvt", "5:files", "6:tex", "7:code", "8:video", "9:other" },
...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "XF86Sleep", function () awful.util.spawn("systemctl suspend", false) end,
              {description = "sleep", group = "power"}),
    awful.key({ modkey,           }, "backslash", function () awful.util.spawn("xfce4-appfinder") end,
              {description = "launch app-finder", group = "apps"}),
    awful.key({ modkey,           }, "b", function () awful.util.spawn("chromium") end,
              {description = "launch chromium", group = "apps"}),
    awful.key({ modkey,           }, "XF86Explorer", function () awful.util.spawn("chromium") end,
              {description = "launch chromium", group = "apps"}),
    awful.key({ modkey,           }, "s", function () awful.util.spawn("spacefm") end,
              {description = "launch spacefm", group = "apps"}),
    awful.key({ modkey,           }, "y", function () awful.util.spawn("quodlibet") end,
              {description = "launch quodlibet", group = "apps"}),
